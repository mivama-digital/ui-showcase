export const componentPages = [
  ...
  { href: "/content", label: "Content", description: "Typography, Card, and Message defaults" },
  { href: "/feedback", label: "Feedback", description: "Alert, Progress, Skeleton, Empty, Avatar, and Toast defaults" },
  { href: "/forms", label: "Forms", description: "Input, Textarea, Switch, Field, Select, Choice, and Slider primitives" },
